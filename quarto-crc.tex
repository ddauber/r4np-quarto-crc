...
\NormalTok{mtcars }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ mpg,}
             \AttributeTok{y =}\NormalTok{ hp)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{()}
\end{Highlighting}
\end{Shaded}

\includegraphics{intro_files/figure-pdf/ggplot-geom-point-1.pdf}

See Knuth (1984) for additional discussion of literate
programming\index{literate programming}.

As we can see from Wickham (2021) and Wickham (2014). matters are not
always that easy.
