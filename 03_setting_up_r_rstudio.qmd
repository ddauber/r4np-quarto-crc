...
## RStudio Cloud {#sec-rstudio-cloud}
...
1.  Open your web browser of choice and navigate to <https://rstudio.cloud>.
    ...
    ![](images/chapter_03_img/rstudio_cloud/01_rstudio_cloud.png){fig-alt="Screenshot of the RStudio Cloud landing page."}
...
3.  On the next page, make sure you have the free plan selected and click on `Sign up`.
    ...
    ![](images/chapter_03_img/rstudio_cloud/02_rstudio_cloud.png){fig-alt="Screenshot showing the RStudio Cloud tiers of use, including the 'Cloud Free' tier which allows using RStudio Cloud for free."}

4.  To finalise the registration process, you are required to provide your credentials.

    ![](images/chapter_03_img/rstudio_cloud/03_rstudio_cloud.png){fig-alt="Screenshot of the RStudio Cloud Sign Up page."}
...
5.  Once you complete your registration, you are redirected to `Your Workspace`, the central hub for all your projects. As you can tell, I already added another workspace called `R for Non-Programmers`. However, it is fine to use the default one.
    ...
    ![](images/chapter_03_img/rstudio_cloud/05_rstudio_cloud.png){fig-alt="Screenshot of the RStudio Cloud landing page after logging into the website. It shows how clicking on 'New Project enables users to choose a new RStudio project in the cloud."}
...
6.  To start a new *R* project, you can click on `New Project > New RStudio Project`. This will open RStudio in the Cloud, which looks identical to the desktop version. You can immediately start writing your code. The example below computes a plot.[^03_setting_up_r_rstudio-1]
    ...
    ![](images/chapter_03_img/rstudio_cloud/06_rstudio_cloud.png){fig-alt="Screenshot of an RStudio Cloud project opened, showing some coding."}

7.  Now we can execute the code as we would on the desktop version (see Chapter \@ref(r-basics-the-very-fundamentals)).

    ![](images/chapter_03_img/rstudio_cloud/07_rstudio_cloud.png){fig-alt="Screenshot of an RStudio Cloud project opened, showing some coding and the plot that results from running this code."}

[^03_setting_up_r_rstudio-1]: RStudio and RStudio Cloud warn you if you need to install certain R packages to successfully run code. More about R packages and what they are can be found in Chapter \@ref(r-packages).
