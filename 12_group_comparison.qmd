...
```{r}
#| label: two-unpaired-groups-effect-size-interpretation
#| echo: true
...
```{r}
#| label: two-paired-groups-line-plot
#| echo: true
...
```{r}
#| label: two-paired-groups-line-plot-full-y-scale
#| echo: true
...
: Comparing two paired groups (effect size functions from package `effectsize`, except for `wilcoxonPairedR()` from `rcompanion`) {#tbl-comparing-two-groups-paired}
...
```{r}
#| label: two-paired-groups-effect-size-interpretation
#| echo: true
...
```{r}
#| label: two-paired-groups-effect-size-nonparametric-interpretation
#| echo: true
...
+----------------+----------------------+--------------------------------------------+------------------------+--------------------------------------------------+
| Assumption     | Test                 | Function for test                          | Effect size            | Function for effect size[^12_group_comparison-1] |
+================+======================+============================================+========================+==================================================+
...
[^12_group_comparison-1]: These functions are taken from the `effectsize` package.
...
+==================================+=================+====================+==================================================================================================================================================================================================+
| YES                              | YES             | -   REGWQ,         | -   `mutoss::regwq()`[^12_group_comparison-2]                                                                                                                                                    |
|                                  |                 |                    |                                                                                                                                                                                                  |
...
[^12_group_comparison-2]: In order to use this package, it is necessary to install a series of other packages found on [bioconductor.org](https://www.bioconductor.org "bioconductor.org"){target="blank"}
...
+----------+--------------------------+----------------------------------------------------+-------------------------------------------------------------+---------------+
| 2x2      | \> 10 obs.               | Chi-squared Test with Yate's Continuity Correction | `infer::chisq_test(correct = TRUE)`[^12_group_comparison-3] | `phi()`       |
+----------+--------------------------+----------------------------------------------------+-------------------------------------------------------------+---------------+
...
[^12_group_comparison-3]: `infer` is an R package which is part of `tidymodels`.
