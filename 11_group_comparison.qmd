...
As you already know, there are situations where we want to turn a 'wide' data frame into a 'long' one. We performed such a step earlier and there is an in-depth example provided in @sec-reviewing-the-outliers. Knowing how to pivot dataset is an essential data wrangling skill and something you should definitely practice to perfection.
