...
Ultimately, you need to be able to effectively work with your data and output. Ideally, this should be true for others as well who want or need to work with your analysis and data as well, e.g. your co-investigator or supervisor. The same is applies to column names in datasets (see @sec-colnames-cleaning). Some more information about coding style and coding etiquette can be found in @sec-coding-etiquette.
